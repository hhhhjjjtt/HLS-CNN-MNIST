...
entity layers_test_axis_to_nn_784_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of layers_test_axis_to_nn_784_s is 
...
attribute shreg_extract : string;
    ...
    signal i1_fu_52 : STD_LOGIC_VECTOR (9 downto 0) := "0000000000";
    signal i_fu_88_p2 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    component layers_test_flow_control_loop_pipe IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    flow_control_loop_pipe_U : component layers_test_flow_control_loop_pipe
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => real_start,
    ...
    regslice_both_stream_in_V_data_V_U : component layers_test_regslice_both
    generic map (
        DataWidth => 8)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_V_keep_V_U : component layers_test_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_V_strb_V_U : component layers_test_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_stream_in_V_last_V_U : component layers_test_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    ap_block_state1_pp0_stage0_iter0_assign_proc : process(input_to_conv0_full_n, ap_done_reg, ap_start_int, stream_in_TVALID_int_regslice)
    begin
                ap_block_state1_pp0_stage0_iter0 <= ((ap_done_reg = ap_const_logic_1) or (input_to_conv0_full_n = ap_const_logic_0) or (stream_in_TVALID_int_regslice = ap_const_logic_0) or (ap_start_int = ap_const_logic_0));
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0, icmp_ln34_fu_94_p2)
    begin
        if (((icmp_ln34_fu_94_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    i_fu_88_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i1_load) + unsigned(ap_const_lv10_1));
    icmp_ln34_fu_94_p2 <= "1" when (ap_sig_allocacmp_i1_load = ap_const_lv10_30F) else "0";

    input_to_conv0_blk_n_assign_proc : process(ap_CS_fsm_state1, input_to_conv0_full_n, ap_done_reg, ap_start_int)
    begin
    ...
    input_to_conv0_din <= stream_in_TDATA_int_regslice;

    input_to_conv0_write_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0)
    begin
        if (((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            input_to_conv0_write <= ap_const_logic_1;
        else 
            input_to_conv0_write <= ap_const_logic_0;
        end if; 
    end process;
    ...
    stream_in_TDATA_blk_n_assign_proc : process(ap_CS_fsm_state1, ap_done_reg, ap_start_int, stream_in_TVALID_int_regslice)
    begin
        if ((not(((ap_done_reg = ap_const_logic_1) or (ap_start_int = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    stream_in_TREADY_int_regslice_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0)
    begin
        if (((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
