...
entity layers_test_start_for_pool_layer_32_7_2_2_U0 is 
    generic (
...
architecture rtl of layers_test_start_for_pool_layer_32_7_2_2_U0 is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component layers_test_start_for_pool_layer_32_7_2_2_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_layers_test_start_for_pool_layer_32_7_2_2_U0_ShiftReg : layers_test_start_for_pool_layer_32_7_2_2_U0_ShiftReg
    generic map (
...
entity layers_test_start_for_pool_layer_32_7_2_2_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end layers_test_start_for_pool_layer_32_7_2_2_U0_ShiftReg;

architecture rtl of layers_test_start_for_pool_layer_32_7_2_2_U0_ShiftReg is
