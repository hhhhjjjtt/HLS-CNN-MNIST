...
entity layers_test_fifo_w8_d10_S is 
    generic (
...
architecture rtl of layers_test_fifo_w8_d10_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component layers_test_fifo_w8_d10_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 8;
        ADDR_WIDTH : integer := 4;
        DEPTH      : integer := 10);
...
begin
----------------------- Instantiation -----------------------
    U_layers_test_fifo_w8_d10_S_ShiftReg : layers_test_fifo_w8_d10_S_ShiftReg
    generic map (
...
entity layers_test_fifo_w8_d10_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 8;
        ADDR_WIDTH : integer := 4;
        DEPTH      : integer := 10);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end layers_test_fifo_w8_d10_S_ShiftReg;

architecture rtl of layers_test_fifo_w8_d10_S_ShiftReg is
